...
def calculateErrorRate(matrix1, matrix2, p1, p2, trainingMatrix1, trainingMatrix2):
    '''
    ...
    sigma = calculatePooledCorvarianceMatrix(trainingMatrix1, trainingMatrix2)

    # finds the mean of the two matrixes for each layer
    mu1 = np.mean(trainingMatrix1, axis=0).T
    mu2 = np.mean(trainingMatrix2, axis=0).T
...
if __name__ == "__main__":
    ...
    errorrate, error_fat, error_meat = calculateErrorRate(fatPix, meatPix, 0.30, 0.70, fatPix, meatPix,)
